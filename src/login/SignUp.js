...
const SignUpPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (signUpForm.password === signUpForm.passwordRepeat) {
      try {
        const response = await axios.post(`http://karlis-veckagans.atwebpages.com/PHP/signup.php`, {
  ...
  const fetchAllUsers = () => {
    axios.get('http://karlis-veckagans.atwebpages.com/PHP/signup.php').then((response) => {
